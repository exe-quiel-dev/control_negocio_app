...
const EditarProveedor = () => {
  ...
  const provFiltrado = provs.filter(proveedor => proveedor.id === datos.proveedorId);
  const { nombre, saldo, pagado } = provFiltrado[0];
  ...
  const handdleEditarProveedor = e => {
    e.preventDefault()
    provFiltrado[0].nombre = nombreActualizado
    provFiltrado[0].pagado = pagadoActualizado
    provFiltrado[0].saldo = saldoActualizado
    ...
    <main className="flex flex-col items-center justify-center container mx-auto gap-4 p-5">
      ...
      >
        ...
        <input
          ...
          defaultValue={provFiltrado[0]?.nombre}
        ...
        <input
          ...
          defaultValue={provFiltrado[0]?.pagado}
        ...
        <input
          ...
          name="saldo"
          className="text-lg p-2 outline-none rounded-lg w-full md:w-1/2"
          defaultValue={provFiltrado[0]?.saldo}
